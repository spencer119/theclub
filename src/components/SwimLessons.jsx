...
import SwimTeamPdf from "../assets/Swim Team Information.pdf";
import LevelsPdf from "../assets/Spring Swim Lessons.pdf";
import SchedulePdf from "../assets/Spring Schedule 2024.pdf";
      ...
      <>
        <Container sm css={{ mt: 50 }}>
          <Grid.Container justify="center" gap={1}>
            ...
            <Grid xs={12} justify="center">
              <Text h4>
                You will recieve an email when more information is available
              </Text>
            </Grid>
            <Grid xs={12} justify="center">
              <Button onClick={() => setDidSubmit(false)}>
      ...
      <>
        <Container sm css={{ mt: 5 }}>
          <Grid.Container justify="center" gap={1}>
            ...
            <Grid xs={12} justify="flex-start">
              <Text h4>
                What type of lessons are you interested in? (Select one or
                multiple)
              </Text>
            </Grid>
            <Grid xs={12} justify="flex-start">
              <Checkbox
                label="Group Lessons"
                value={groupLessons}
                onChange={(e) => setGroupLessons(e)}
              />
              <Spacer x={4} />
              <Checkbox
                label="Private Lessons"
                value={privateLessons}
                onChange={(e) => setPrivateLessons(e)}
              />
              <Spacer x={4} />
              <Checkbox
                label="Swim Team"
                value={swimTeam}
                onChange={(e) => setSwimTeam(e)}
              />
            </Grid>
            {/* <Grid xs={12} justify='flex-start'>
            ...
            <Grid xs={12} justify="flex-start">
              <Checkbox
                label="Are you a member at The Club?"
                value={isMember}
                onChange={(e) => setIsMember(e)}
              />
            </Grid>
            {/* <Grid xs={12} justify='flex-start'>
            <Text h4>Are you a member at The Club?</Text>
            ...
            <Grid xs={12} justify="flex-start">
              <Checkbox
                label="I would like to receive future swim notifications."
                value={futureEmails}
                onChange={(e) => setFutureEmails(e)}
              />
            </Grid>
            <Spacer y={2} />
            <Grid justify="space-around" sm={6} xs={12}>
              <Button as="a" target="_blank" href={LevelsPdf}>
                See Swim Levels
              </Button>
              <Button as="a" target="_blank" href={SchedulePdf}>
                See Classes Available Now
              </Button>
            </Grid>
            <Grid xs={12} justify="center">
              <Button as="a" href={SwimTeamPdf}>
            ...
            <Grid xs={12} justify="center">
              <Text h4>
                Please call the Aspen Club to register for classes. 208-634-5838
              </Text>
            </Grid>
            <Spacer y={4} />

            <Grid xs={12} justify="center">
              <Button color="success" size="lg" onClick={submit}>
                Sign Up
              </Button>
            </Grid>
          </Grid.Container>
